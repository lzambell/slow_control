...
heights = {}
with open('np04_temperature_height.csv', mode='r', encoding='utf-8-sig') as f:
...
dates = glob.glob('../temp_evo_filling/*_np04.npz')
dates = sorted(dates)
...
plt.tight_layout()
fig.savefig('np04_temperature_evolution.png', dpi=200)
